...
const CompanyFeatures = () => {
  return (
    <div className="py-32 flex flex-row gap-32 justify-center">
      {[1, 1, 1].map((i) => (
        <div className="flex flex-col gap-2 items-center" key={i}>
          <svg
            ...
            height="40"
            viewBox="0 0 41 40"
            className="bg-black rounded-full h-20 w-20 p-2 border-8 border-gray-300"
            fill="none"
          >
            <g clip-path="url(#clip0_848_335)">
              <path
